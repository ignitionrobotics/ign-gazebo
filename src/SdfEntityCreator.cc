...
// Note: ideally, we would include only the components used in this file, but
// including all known components here ensures that they are registered to the
// factory when libignition-gazebo.so gets loaded.
// See https://github.com/ignitionrobotics/ign-gazebo/issues/806
